...
Route::get('/histories/create/{id}',[HistoriesController::class, 'create'])->name('histories.create');
Route::delete('/histories/delete/{id}',[HistoriesController::class, 'destroy'])->name('histories.destroy');
