                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="mb-3 input-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('info') ? ' is-invalid' : '' }}" id="info" name="info" value="{{ $email->info }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" value="{{ $email->email }}"required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3 input-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" id="phone" name="phone" value="{{ $email->phone }}" required>
